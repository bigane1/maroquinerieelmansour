            ...
            <div class="member-profile-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-xl-3 col-md-4">
                        <div class="member-profile-img bg-cover bg-center" ><img src="assets/img/maroquinerie/sacmain01.jpg" alt=""></div>
                    </div>
               
                    <div class="col-lg-8 d-sm-flex justify-content-between col-md-8 col-xl-9">
                        <div class="member-info">
                            <h2>SAC À MAIN MAROCAIN</h2>
                            <span>600 DH</span>
                            <p>
                            Sac en cuir marocain  sac à bandoulière en cuir véritable noir fait à la main, sac en cuir authentique, cadeau pour elle
                            </p>
                            <?php
...
<div class="col-lg-4 col-md-6 grid-item plafonnier">
 ...
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/maroquinerie/sacmain02.jpg" class="d-block popup-link"><img src="assets/img/maroquinerie/sacmain02.jpg" alt=""></a>
     </div>    
 </div>
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/maroquinerie/sacmain03.jpg" class="d-block popup-link"><img src="assets/img/maroquinerie/sacmain03.jpg" alt=""></a>
     </div>  
