            ...
            <div class="member-profile-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-xl-3 col-md-4">
                        <div class="member-profile-img bg-cover bg-center" ><img src="assets/img/maroquinerie/sacuni01.jpg" alt=""></div>
                    </div>
               
                    <div class="col-lg-8 d-sm-flex justify-content-between col-md-8 col-xl-9">
                        <div class="member-info">
                            <h2>SAC CLASSIC MAROCAIN</h2>
                            <span>600 DH</span>
                            <p>
                            Sac classic Marocain
                            </p>
                            <?php
...
<div class="col-lg-4 col-md-6 grid-item plafonnier">
 ...
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/maroquinerie/sacuni02.jpg" class="d-block popup-link"><img src="assets/img/maroquinerie/sacuni02.jpg" alt=""></a>
     </div>    
 </div>
