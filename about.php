...
<body class="body-wrapper">    
    ...
    <div id="preloader" class="preloader">
        <div class="animation-preloader">
            ...
            <p class="text-center">Loadingx</p>
        </div>
        <div class="loader">
            <div class="row">
        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <div class="header-right-area d-flex">
                <div class="main-menu d-none d-xl-block">
                    <ul>
                        <li><a href="index.php">Home <i class="fal fa-plus"></i></a>
                            <ul class="sub-menu">
                        ...
                        <li><a href="#searchbar"><i class="fas fa-search"></i></a></li>
                    </ul>
                </div>
                <div class="header-right-elements d-flex align-items-center justify-content-between">
                    <a href="contact.php" class="theme-btn d-none d-sm-block">Get Free Quote</a>
    ...
    <div class="page-banner-wrap bg-cover" style="background-image: url('assets/img/page-banner.jpg')">
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-sm-6 offset-xl-1 col-xl-3 ps-xl-5 col-12">
                        <div class="single-footer-wid">
                            ...
                            <ul>
                                ...
                                <li><a href="contact.php">Payment Getway</a></li>
                            </ul>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-12 text-center text-md-left">
                        <div class="copyright-info">
                            <p>&copy; 2021 Copyright By <a href="index.php">Busico</a>. All Rights Reserved</p>
                        </div>
                    </div>
