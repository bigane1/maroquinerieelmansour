            ...
            <div class="member-profile-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-xl-3 col-md-4">
                        <div class="member-profile-img bg-cover bg-center" ><img src="assets/img/dinanderie/plafonnier07.jpg" alt=""></div>
                    </div>
               
                    <div class="col-lg-8 d-sm-flex justify-content-between col-md-8 col-xl-9">
                        <div class="member-info">
                            <h2>DIVA – PLAFONNIER EN CUIVRE</h2>
                            <span>1000 DH</span>
                            <p>Plafonnier en cuivre pour émerveiller et redonner vie à la décoration de votre intérieur oriental. Votre boutique d’artisanat marocain en ligne introduit ce beau luminaire pour les fans de la déco marocaine.
...
<div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/dinanderie/plafonnier05.jpg" class="d-block popup-link"><img src="assets/img/dinanderie/plafonnier05.jpg" alt=""></a>
     </div>    
 </div>
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
 ...
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/dinanderie/plafonnier07.jpg" class="d-block popup-link"><img src="assets/img/dinanderie/plafonnier07.jpg" alt=""></a>
     </div>    
 </div>
