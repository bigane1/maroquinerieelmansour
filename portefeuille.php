            ...
            <div class="member-profile-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-xl-3 col-md-4">
                        <div class="member-profile-img bg-cover bg-center" ><img src="assets/img/maroquinerie/portefeuille01.jpg" alt=""></div>
                    </div>
               
                    <div class="col-lg-8 d-sm-flex justify-content-between col-md-8 col-xl-9">
                        <div class="member-info">
                            <h2>PORTEFEUILLE EN CUIR CLASSIC MAROCAIN</h2>
                            <span>600 DH</span>
                            <p>
                            Portefeuille en cuir fait main de sac à main en cuir, unisexe marocain de cuir véritable disponible 10 adapté aux besoins du client
                            </p>
                            <?php
...
<div class="col-lg-4 col-md-6 grid-item plafonnier">
 ...
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/maroquinerie/portefeuille02.jpg" class="d-block popup-link"><img src="assets/img/maroquinerie/portefeuille02.jpg" alt=""></a>
     </div>    
 </div>
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/maroquinerie/portefeuille03.jpg" class="d-block popup-link"><img src="assets/img/maroquinerie/portefeuille03.jpg" alt=""></a>
     </div>  
