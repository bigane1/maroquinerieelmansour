            ...
            <div class="member-profile-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-xl-3 col-md-4">
                        <div class="member-profile-img bg-cover bg-center" ><img src="assets/img/tapis/coussin01.jpg" alt=""></div>
                    </div>
               
                    <div class="col-lg-8 d-sm-flex justify-content-between col-md-8 col-xl-9">
                        <div class="member-info">
                            <h2>coussin marocain Kilim rouge</h2>
                            <span>800 DH</span>
...
<div class="col-lg-4 col-md-6 grid-item plafonnier">
 ...
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/tapis/coussin02.jpg" class="d-block popup-link"><img src="assets/img/tapis/coussin02.jpg" alt=""></a>
     </div>    
 </div>
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/tapis/coussin03.jpg" class="d-block popup-link"><img src="assets/img/tapis/coussin03.jpg" alt=""></a>
     </div>    
 </div>
