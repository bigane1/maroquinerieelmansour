            ...
            <div class="member-profile-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-xl-3 col-md-4">
                        <div class="member-profile-img bg-cover bg-center" ><img src="assets/img/dinanderie/theiere01.jpg" alt=""></div>
                    </div>
               
                    <div class="col-lg-8 d-sm-flex justify-content-between col-md-8 col-xl-9">
                        <div class="member-info">
                            <h2>BERRAD – THÉIÈRE ARTISANALE EN CUIVRE NICKELÉ</h2>
                            <span>500 DH</span>
                            <p>BERRAD est une théière en cuivre nickelé soigneusement ciselée à la main par les artisans marocains basés à Fès. Votre référence en objets décoratifs de luxe et artisanat marocain, 
                                Artisanat Maroc Marrakech, vous le propose à PETIT PRIX. Hauteur : 18 CM Diamètre : 13 CM
                            </p>
...
<div class="col-lg-4 col-md-6 grid-item plafonnier">
 ...
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/dinanderie/theiere02.jpg" class="d-block popup-link"><img src="assets/img/dinanderie/theiere02.jpg" alt=""></a>
     </div>    
 </div>
 <div class="col-lg-4 col-md-6 grid-item plafonnier">
     <div class="project-item-card">
         <a href="assets/img/dinanderie/theiere03.jpg" class="d-block popup-link"><img src="assets/img/dinanderie/theiere03.jpg" alt=""></a>
     </div>    
 </div>
